...
- The main remaining fidelity gap is richer Confluence-aware conversion for advanced macros beyond the currently supported page-link, mention, status, layout, excerpt, excerpt-include, include-page, page-tree, page-tree-search, page-index, spaces-list, space-details, space-attachments, Live Search, TOC zone, content-properties, content-properties-report, attachments, blog-posts, contributors, contributors-summary, recently-updated-dashboard, content-by-label, recently-updated, labels-list, popular-labels, related-labels, recently-used-labels, gallery, favorite-pages, change-history, profile, status-list, network, children, TOC, panel, expand, code, and noformat cases; unsupported nodes are preserved safely rather than rendered into editable Markdown.
