...
- The main remaining fidelity gap is richer Confluence-aware conversion for advanced macros beyond the currently supported page-link, mention, status, layout, excerpt, excerpt-include, include-page, page-tree, page-tree-search, page-index, Live Search, TOC zone, content-properties, content-properties-report, content-by-label, recently-updated, labels-list, popular-labels, related-labels, children, TOC, panel, expand, and code cases; unsupported nodes are preserved safely rather than rendered into editable Markdown.
